...
Dropped per owner: roadmap-capture purpose fulfilled by extracting the worthwhile ideas to top-level yaks — calcifer-851f (custom-backend tier), calcifer-7b34 (Wiki view), calcifer-d720 (Seafile view), calcifer-0917 (far tiers: sandboxed render + live SSE).
