...
Complete. A1 responsive foundation, A2 unified sidebar, A3 mobile-drawer hygiene, A4 Cmd+K palette all shorn. Single collapsible nav surface (rail on desktop → merged drawer on mobile) with modal a11y, plus keyboard search across conversations + apps.
