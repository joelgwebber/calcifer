...
// Cross-agent shared data root under the canonical operational dir (data/).
// Skills that produce family-shared data (one writer, many readers) live here
// and are mounted into every agent's container at a common path. The web view
